package com.atguigu.bigdata.zhaocheng.window
...
/**
  * Create by chenqinping on 2019/6/10 10:56
  */
object TimeWindowStreamApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val textDstream: DataStream[String] = env.socketTextStream("hadoop102",4444)
