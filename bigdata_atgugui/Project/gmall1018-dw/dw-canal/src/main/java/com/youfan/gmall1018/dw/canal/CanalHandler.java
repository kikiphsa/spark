...
import com.youfan.gmall1018.dw.util.MyKafkaSender;

import java.util.List;

/**
 * Create by chenqinping on 2019/5/3 19:31
 */
public class CanalHandler {

    public static void handle(String tableName, CanalEntry.EventType eventType, List<CanalEntry.RowData> rowDatasList) {
        if ("order_info".equals(tableName) && eventType.equals(CanalEntry.EventType.INSERT) && null != rowDatasList && rowDatasList.size() > 0) {
