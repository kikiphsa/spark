...
/**
 * Create by chenqinping on 2019/4/20 14:26
 */
public class BaseFieldUDF extends UDF {
    ...
    public String evaluate(String line, String jsonkeysString) {
        ...
        if (logContents.length != 2 || StringUtils.isBlank(logContents[0])) {
            return "";
        }
        ...
        try {
            ...
            for (int i = 0; i < jsonKeys.length; i++) {
                ...
                String findName = jsonKeys[i].trim();

                if (base.has(findName)){
                    sb.append(base.getString(findName)).append("\t");
                }else{
                    sb.append("\t");
                }
            }
