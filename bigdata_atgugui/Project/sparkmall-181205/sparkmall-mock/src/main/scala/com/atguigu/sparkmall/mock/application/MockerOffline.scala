...
import com.atguigu.sparkmall.common.model.DateModel.{ProductInfo, UserInfo, UserVisitAction, CityInfo}
...
object MockerOffline {
  ...
  def insertHive(sparkSession: SparkSession, tableName: String, dataFrame: DataFrame): Unit = {
    sparkSession.sql("use sparkmall181205")
  ...
  def mockUserAction() = {
    ...
    val endDate = new SimpleDateFormat("yyyy-MM-dd").parse("2019-11-27")
