...
/**
  * Create by chenqinping on 2019/5/21 9:09
  */

import com.atguigu.sparkmall.common.model.DateModel.CityInfo
import com.atguigu.sparkmall.common.util.ConfigurationUtil
import org.apache.kafka.clients.producer.{KafkaProducer, ProducerConfig, ProducerRecord}
import java.text.SimpleDateFormat
import java.util.{Properties, UUID}

import com.atguigu.sparkmall.common.model.DateModel.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.sparkmall.mock.util.{RandomNum, RandomOptions}
import com.atguigu.sparkmall.mock.util._
...
object MockRealTimeGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = ConfigurationUtil.getValueFromConfig("kafka.broker.list")
    val topic = "ads_log"
    // 创建Kafka消费者
    val kafkaProducer = createKafkaProducer(config)
